...
export const tasks: Task[] = [
  ...
  },
  {
    ...
    description:
      'Gather requirements and prepare the agenda for the project kickoff meeting.',
    avatars: [
      {
  ...
  },
  {
    ...
    description:
      'Write and run unit tests for the user login flow to ensure reliability.',
    avatars: [
      {
        src: 'https://cdn.jsdelivr.net/gh/alohe/avatars/png/vibrent_15.png',
        alt: '@em',
        fallback: 'EM',
      },
    ],
  ...
  },
  {
    ...
    description:
      'Coordinate with the team to schedule the next sprint review meeting.',
    avatars: [
      {
        src: 'https://cdn.jsdelivr.net/gh/alohe/avatars/png/vibrent_19.png',
        alt: '@nl',
        fallback: 'NL',
      },
    ],
  ...
  },
  {
    ...
    description:
      'The homepage layout implementation is ready for review by the design team.',
    avatars: [
      {
        src: 'https://cdn.jsdelivr.net/gh/alohe/avatars/png/vibrent_24.png',
        alt: '@js',
        fallback: 'JS',
      },
      {
        src: 'https://cdn.jsdelivr.net/gh/alohe/avatars/png/vibrent_27.png',
        alt: '@em',
        fallback: 'EM',
      },
    ],
  ...
  },
  {
    ...
    description:
      'Sync with QA team to review the latest bug reports and fixes.',
    avatars: [
      {
        src: 'https://cdn.jsdelivr.net/gh/alohe/avatars/png/vibrent_5.png',
        alt: '@qa',
