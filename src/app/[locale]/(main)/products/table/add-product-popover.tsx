        ...
        setErrors((prev) => ({
          ...
          general:
            err instanceof Error
              ? err.message
              : t('Messages.failedSave', {
                  item: t('Products.modal.detailsTitle'),
                }),
        }));
      },
    });
        ...
        <div className="space-y-4 sm:space-y-6">
          ...
          >
            ...
            <div className="space-y-2 flex flex-col items-center">
              ...
              >
                {imageSrc ? (
                  <Image
                    src={imageSrc}
                    alt={t('Products.image.fallbackAlt')}
                    fill
                    unoptimized
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  className="h-8 sm:h-9 text-xs"
                  placeholder={t('Products.placeholders.productCode')}
                />
                {errors.code && (
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
              ...
              <div className="space-y-2">
                <Label className="text-xs">{t('Products.fields.status')}</Label>
                <Select
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
              <div className="space-y-2">
                <Label className="text-xs">{t('Products.fields.price')}</Label>
                <Input
                  type="number"
                  step="0.01"
              ...
              <div className="space-y-2">
                <Label className="text-xs">{t('Products.fields.stock')}</Label>
                <Input
                  type="number"
