...
const PersonalInformationCard = ({
  ...
  const personalInfoT = useTranslations('Account.personalInfo');
  const formsT = useTranslations('Forms.fields');
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>{personalInfoT('description')}</CardDescription>
      </CardHeader>
        ...
        <form onSubmit={handleUpdateAccountInfo} className="space-y-6">
          <div className="flex items-center gap-4">
            ...
            <div className="space-y-2">
              ...
              >
                {buttonsT('changePhoto')}
              </Button>

              <p className="text-sm text-muted-foreground">
                {personalInfoT('imageLimit')}
              </p>
            </div>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
              <Label htmlFor="name">{formsT('fullName')}</Label>
              <Input
                id="name"
                value={user?.name}
            ...
            <div className="space-y-2">
              <Label htmlFor="phone">{formsT('phone')}</Label>
              <Input
                id="phone"
                value={user?.phone || ''}
            ...
            <div className="space-y-2">
              <Label htmlFor="company">{formsT('company')}</Label>
              <Input
                id="company"
                value={user?.company || ''}
            ...
            <div className="space-y-2">
              <Label htmlFor="location">{formsT('location')}</Label>
              <Input
                id="location"
                value={user?.location || ''}
          ...
          <div className="flex justify-end">
            ...
            >
              {isUpdating ? buttonsT('saving') : buttonsT('save')}
            </Button>
          </div>
        </form>
      </CardContent>
